...
#define     ITEM_FLAG_TRIGER	(1 << 20)	// 트리거 이벤트에 사용되는 아이템
#endif // TRIGER_SYSTEM
...
#define		MAX_SEAL_TYPE_SKILL		5			// 제작 스킬 갯수
...
//////////trigerSet_type///////
#define TRIGERSET_ALTER_OF_DARK						1	// 암흑의 제단
#define TRIGERSET_CHEPEL_1							2	// 예배당 1차
#define TRIGERSET_TESTRAID							3	// 테스트 Raid

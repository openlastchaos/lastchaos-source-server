...
#define PULSE_HACK_CLIENT_THRESHOLD	(55 * PULSE_REAL_SEC)	// 핵 펄스 클라이언트 최소 주기 55초 이보다 자주 보내면 ?
...
#define MAX_ASSIST_HELP			20		// 보조 효과 : 이로운 것
...
#define		ITEM_FLAG_GENERAL	(1 << 17)	// 일반전용아이템
...
#define		SEAL_TYPE_DETAIL		0			// 정교한
#define		SEAL_TYPE_COLORFUL		1			// 화려한
#define		SEAL_TYPE_SHARP			2			// 날카로운
#define		SEAL_TYPE_HARD			3			// 단단한
#define		SEAL_TYPE_CONSUME		4			// 소모품
...
#define ZONE_TEST_EXTRA					32		// 테스트용 존
...
#define		MAX_NUM_OPTION				66		// 옵션 총 숫자
...
#if defined(TEST_SERVER) || defined(LC_KOR) || defined(LC_USA) || defined(LC_JPN)
...
#ifdef RAID_MONSTER_SKILL
#define STATE_MONSTER_CALLING		(1 << 2)	// 몬스터 호출된 상태
#endif // RAID_MONSTER_SKILL
...
#define TRIGER_MAX_ARRAYCOUNT		10		// 트리거 맴버 변수 중 배열인 것의 최대 열 개수

//////////triger_type///////
#define TRIGER_FIRST_TAB					0		// 초기 탭 화면
#define TRIGER_ITEM_COMPOSITION				1		// 아이템 결합
#define TRIGER_ITEM_DROP					2		// 아이템 드랍
#define TRIGER_OPEN_THE_DOOR				3		// 문 열기
#define TRIGER_START_RAID					4		// 레이드 시작(시작 시간 설정 가능)
#define TRIGER_MESSAGE_PRINT				5		// 게임 메세지 출력
#define TRIGER_SUMMON_NPC					6		// npc 소환
#define TRIGER_USE_DEBUF					7		// 디버프 걸림
#define TRIGER_ACTIVE_OBJECT				8		// Object 활성화
#define TRIGER_REMOVE_NPC					9		// npc 자동 제거

//////////triger_Subtype_OpenTheDoor///////
#define TRIGER_SUBTYPE_NONE_OPEN_THE_DOOR	0
#define TRIGER_SUBTYPE_NPC_OPEN_THE_DOOR	1
#define TRIGER_SUBTYPE_ITEM_OPEN_THE_DOOR	2

//////////triger_Subtype_OpenTheDoor///////
#define TRIGER_SUBTYPE_NONE_REMOVE_NPC		0
#define TRIGER_SUBTYPE_ITEM_REMOVE_NPC		1

//////////triger_ActionType///////
#define TRIGER_ACTIONTYPE_IMMEDIATELY		1		// 즉시 실행
#define TRIGER_ACTIONTYPE_ACTIVITY			2		// 활성화만 됨, client에서 실행 여부 결정
